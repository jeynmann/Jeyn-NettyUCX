...
public final class NettyUcxMessageEncoder extends MessageToMessageEncoder<Message> {

  private static final Logger logger = LoggerFactory.getLogger(NettyUcxMessageEncoder.class);

  public static final NettyUcxMessageEncoder INSTANCE = new NettyUcxMessageEncoder();

  private NettyUcxMessageEncoder() {}
